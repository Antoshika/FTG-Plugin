...
class AdminToolsMod(loader.Module):
    ...
    strings = {'name': 'Админские Плюшки!',
               'no_reply': '<b>Где картинка/стикер?!.</b>',
               'not_pic': '<b>Дядь, это не каритинка/стикер.</b>',
               'wait': '<b>Щя погодь...</b>',
               'pic_so_small': '<b>Фотография мелкая, отправь другую!b>',
               'pic_changed': '<b>Аватарка мусорки поменялась!</b>',
               'promote_none': '<b>Нету некого повышать.</b>',
               'who': '<b>Блять, кто это?!</b>',
               'not_admin': '<b>Дядь, мы тут не Админы.</b>',
               'promoted': '<b>{} повысили стажёром мусорки\nРанг: {}</b>',
               'wtf_is_it': '<b>Кто это, блять?</b>',
               'this_isn`t_a_chat': '<b>Придурок, это не чат!</b>',
               'demote_none': '<b>Нету некого понижать.</b>',
               'demoted': '<b>{} понижен в сильверы мусорки</b>',
               'pinning': '<b>Понинг...</b>',
               'pin_none': '<b>Чё закрепить тебе на обоях?</b>',
               'unpinning': '<b>Открепил твоё художество.</b>',
               'unpin_none': '<b>Покажи что открепить?</b>',
               'no_rights': '<b>У меня нету прав,они купленны.</b>',
               'pinned': '<b>Приебашил к стенку, успешно!</b>',
               'unpinned': '<b>Отебалиш от стенке, успешно!</b>',
               'can`t_kick': '<b>Не могу этого осла кикнуть. :/</b>',
               'kicking': '<b>Происходит кидалово...</b>',
               'kick_none': '<b>Некого кикать...</b>',
               'kicked': '<b>{} выкинут нахуй...</b>',
               'kicked_for_reason': '<b>{} выебнут из мусорки.\nПричина: {}.</b>',
               'banning': '<b>Клацаем Бан...</b>',
               'banned': '<b>{} поймал маслину...</b>',
               'banned_for_reason': '<b>{} был выебан.\nПричина: {}</b>', 
               'ban_none': '<b>Некому дать в ебало...</b>',
               'unban_none': '<b>Некого воскресить.</b>',
               'unbanned': '<b>{} воскрес в чат...</b>',
               'mute_none': '<b>Некому давать кляп.</b>',
               'muted': '<b>{} теперь в кляпе на </b>',
               'no_args': '<b>Осёл, неправильно ввёл команду!.</b>',
               'unmute_none': '<b>Некому вынуть кляп.</b>',
               'unmuted': '<b>{} теперь не в кляпе.</b>',
               'no_reply': '<b>ГДЕ РЕПЛЕЙ?!.</b>',
               'deleting': '<b>Происходит уничтожение...</b>',
               'no_args_or_reply':'<b>Нет аргументов или реплая.</b>',
               'deleted': '<b>Все сообщения от этого еблана {} были успешно удалены!</b>',
               'del_u_search': '<b>Идёт поиск кого-то ёбанного аккаунта...</b>',
               'del_u_kicking': '<b>Кик удалённых аккаунтов...\nБлять, я могу это сделать?!</b>'}
